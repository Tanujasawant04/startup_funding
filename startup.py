...
font = ('times', 16, 'bold')
title = Label(main, text='Startup Funding Data Analysis By Tanuja')
...
cleanStepsButton = Button(main, text="Cleaning Steps", command=showCleaningSteps)
...
visualizeButton = Button(main, text="Visualize ", command=visualizeinsights)
